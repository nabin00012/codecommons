...
export default function LeaderboardPage() {
  ...
  const getBadgeColor = (badge: string) => {
    if (badge.includes("Expert") || badge.includes("Master")) return "bg-purple-100 text-purple-800 border-purple-200"
    if (badge.includes("Star") || badge.includes("Top")) return "bg-amber-100 text-amber-800 border-amber-200"
    if (badge.includes("Guru") || badge.includes("Wizard")) return "bg-blue-100 text-blue-800 border-blue-200"
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Top contributors for March 2025. See who's making the biggest impact in our community.
            </p>
          </motion.div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        size="icon"
                        className="h-8 w-8"
                        onClick={() => setCurrentWeek((prev) => Math.min(weeklyData.length, prev + 1))}
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => setFilterRole("all")}>
                            ...
                            <span>All</span>
                            {filterRole === "all" && <Check className="ml-auto h-4 w-4" />}
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setFilterRole("student")}>
                            <GraduationCap className="mr-2 h-4 w-4" />
                            <span>Students</span>
                            {filterRole === "student" && <Check className="ml-auto h-4 w-4" />}
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setFilterRole("professor")}>
                            <BookOpen className="mr-2 h-4 w-4" />
                            <span>Professors</span>
                            {filterRole === "professor" && <Check className="ml-auto h-4 w-4" />}
                          </DropdownMenuItem>
                          <DropdownMenuSeparator />
                          ...
                          <DropdownMenuItem onClick={() => setSortBy("points")}>
                            ...
                            <span>Points</span>
                            {sortBy === "points" && <Check className="ml-auto h-4 w-4" />}
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setSortBy("solutions")}>
                            <MessageSquare className="mr-2 h-4 w-4" />
                            <span>Solutions</span>
                            {sortBy === "solutions" && <Check className="ml-auto h-4 w-4" />}
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setSortBy("questions")}>
                            <HelpCircle className="mr-2 h-4 w-4" />
                            <span>Questions</span>
                            {sortBy === "questions" && <Check className="ml-auto h-4 w-4" />}
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b bg-muted/50">
                        <th className="px-4 py-3 text-left text-sm font-medium text-muted-foreground w-[60px]">Rank</th>
                    ...
                    <tbody>
                      <AnimatePresence>
                        {filteredContributors.map((contributor, index) => {
                          const RankChange = getRankChange(contributor.rank, contributor.previousRank).icon
                          const rankChangeColor = getRankChange(contributor.rank, contributor.previousRank).color
                          ...
                          return (
                            <motion.tr
                              ...
                              className={`border-b hover:bg-muted/50 transition-colors ${index < 3 ? "bg-gradient-to-r from-amber-50/50 to-transparent dark:from-amber-950/10" : ""}`}
                            >
                                ...
                                <div className="flex items-center gap-1.5">
                                  {index < 3 ? (
                                    ...
                                    <div className="flex items-center gap-1.5">
                                      ...
                                      <RankChange className={`h-3.5 w-3.5 ${rankChangeColor}`} />
                                    </div>
                                  )}
                                </div>
                              </td>
                              ...
                              <td className="px-4 py-4 text-sm text-right font-medium">{contributor.points}</td>
                              ...
                              <td className="px-4 py-4 text-sm">
                                <div className="flex items-center justify-center h-10">
                                  <div className="flex items-end h-8 gap-[3px]">
                                    {contributor.weeklyPoints.map((points, i) => (
                                      <div
                                        key={i}
                                        className={`w-[6px] rounded-t-sm ${
                                          i === currentWeek - 1 ? "bg-primary" : "bg-muted-foreground/30"
                                        }`}
                                        style={{
                                          height: `${Math.max(15, (points / 500) * 100)}%`,
                                        }}
                                      />
                                    ))}
                                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>All-time leaders in our community</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>Faculty members leading by example</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {contributors
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>New members making an impact</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {contributors
                      ...
                      .slice(0, 5)
                      .map((contributor, index) => {
                        const growth = contributor.weeklyPoints[3] - contributor.weeklyPoints[0]
                        const growthPercentage = Math.round((growth / contributor.weeklyPoints[0]) * 100)
