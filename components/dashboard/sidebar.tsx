    ...
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate={{ opacity: 0.5 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-40 bg-background/80 backdrop-blur-sm 2xl:hidden"
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <button
            onClick={() => setIsOpen(false)}
            className="absolute -right-3 top-20 hidden h-6 w-6 items-center justify-center rounded-full border bg-background shadow-sm 2xl:flex"
          >
